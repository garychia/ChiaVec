...
#define CUDAVEC_VECS_IMPLEMENTATION(type)                                                               \
    ...
    void Vec_##type##_init_with_values(Vec_##type *vec, const type *values, size_t size)                \
    {                                                                                                   \
        vec->_ptr = new ChiaVec::Vec<type>(values, size);                                               \
    }                                                                                                   \
    void CudaVec_##type##_init_with_values(CudaVec_##type *vec, const type *values, size_t size)        \
    {                                                                                                   \
        vec->_ptr = new ChiaVec::CudaVec<type>(values, size);                                           \
    }                                                                                                   \
