...
namespace ChiaVec
{
    namespace Memory
    {
        ...
        void DefaultAllocator::copy(void *dst, const void *src, std::size_t size, bool dstOnHost, bool srcOnHost)
        {
            if (dstOnHost)
            {
                if (srcOnHost)
        ...
        void DefaultCudaAllocator::copy(void *dst, const void *src, std::size_t size, bool dstOnHost, bool srcOnHost)
        {
            if (dstOnHost)
            {
                if (srcOnHost)
