...
namespace ChiaVec
{
    namespace Memory
    {
        ...
        struct BaseAllocator
        {
            ...
            virtual void copy(void *dst, const void *src, std::size_t size, bool dstOnHost, bool srcOnHost) = 0;
        };
        ...
        struct DefaultAllocator : BaseAllocator<true>
        {
            ...
            virtual void copy(void *dst, const void *src, std::size_t size, bool dstOnHost, bool srcOnHost) override;
        };
